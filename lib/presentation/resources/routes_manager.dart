...
import '../campaign_detail/campaign_detail_view.dart';
import '/presentation/chat/chat_view.dart';
import '/presentation/discussion/discussion_view.dart';
import '/presentation/forgot_password/forgot_password_view.dart';
import '/presentation/login/login_view.dart';
import '/presentation/onboarding/onboarding_view.dart';
import '/presentation/opt/otp_view.dart';
import '/presentation/resources/strings_manager.dart';
import '/presentation/splash/splash_view.dart';
import '/presentation/start_campaign/start_campaign_view.dart';
import '/presentation/update_password/update_password_view.dart';
import '/presentation/user_type/user_type_view.dart';
  ...
  static Route<dynamic> getRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case RoutesManager.startCampaignRoute:
        return MaterialPageRoute(builder: (_) => StartCampaignView());
      case RoutesManager.campaignDetailRoute:
        return MaterialPageRoute(builder: (_) => CampaignDetailView());
      case RoutesManager.chatRoute:
        return MaterialPageRoute(builder: (_) => ChatView());
      case RoutesManager.discussionRoute:
        return MaterialPageRoute(builder: (_) => DiscussionView());
      default:
        return unDefined();
    }
  }
